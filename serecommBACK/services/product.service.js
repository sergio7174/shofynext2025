...
exports.getProductTypeService = async (req) => {
  ...
  console.log("Estoy en product.service - line 46 - req.params.type: "+req.params.type);
  console.log("Estoy en product.service - line 47 - req.query: "+req.query);
  ...
  if (query.new === "true") {
   ...
   products = await Product.find({ category: type })
    ...
    products = await Product.find({ category: type }).populate("reviews");
  }
  return products;
};
