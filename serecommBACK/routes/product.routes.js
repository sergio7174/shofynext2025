...
// add a product
router.post('/add', uploadFile.fields([{name: 'image', maxCount:1}, {name: 'file',maxCount:1}]),productController.addProduct);
// add all product
...
// get Single Product
//router.put("/edit/:id", uploadFile.fields([{name: 'image', maxCount:1}]),productController.updateProduct);
router.put("/edit/:id",uploadFile.fields([{name: 'image', maxCount:1}]),productController.updateProduct);
// get Products ByType
